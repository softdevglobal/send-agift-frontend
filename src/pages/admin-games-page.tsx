      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-5 flex-1 rounded-xl bg-muted/40 p-4">
          {top && game.top_score !== undefined ? (
            ...
            <p className="py-4 text-center text-sm text-muted-foreground">No verified scores yet</p>
          )}
        </div>
  ...
  return (
    <>
      <AdminPageHeader
        ...
        description="Every skill game, who is playing and who holds the best verified score. Scores only count once the server has replayed them."
        action={
